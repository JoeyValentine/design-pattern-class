...
// listener : 객체에서 이벤트가 발생하면 다른 객체(listener)에 전달
//		=> GoF's 디자인 패턴에 있는 용어 아닙니다.!
// 
// observer : 한개객체에서 발생된 이벤트를 "여러곳" 에 전달한다는 의미!!
// 		=> GoF's 디자인 패턴에 있는 용어입니다.

// listener 를 만들때 "observer" 패턴으로 하자!!!
